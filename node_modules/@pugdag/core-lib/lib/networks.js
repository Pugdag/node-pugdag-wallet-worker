 ...
 *
 * @param {string} prefix Network prefix. E.g.: 'pugdagtest'.
 */
...
const pugdagNetworks = ['pugdag', 'pugdagev', 'pugdagreg', 'pugdagtest', 'pugdagsim'];

pugdagNetworks.map((str) => {
  addNetwork({
    name: str,
    prefix: str,
    pubkeyhash: 0x00, // publickey hash prefix
    privatekey: 0x80, // privatekey prefix -- must be 128 or toWIF() result will not match with pugdag
    scripthash: 0x05,
