...
Pugdag Wallet implements Wallet functionality for the [PugDAG](https://github.com/Pugdag/)
...
## Installing pugdag-wallet

```
npm install -g @pugdag/wallet
```

## Cloning pugdag-wallet

```
git clone https://github.com/Pugdag/node-pugdag-wallet
cd node-pugdag-wallet
npm install
```
...
* `amount` - Amount of PUG in base units (sompis)
