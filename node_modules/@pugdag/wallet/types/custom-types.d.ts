import pugdagcore from '@pugdag/core-lib';
import { PugdagAPI } from 'wallet/apiHelpers';

export type Network = 'pugdag' | 'pugdagev' | 'pugdagreg' | 'pugdagtest' | 'pugdagsim';
export type bytes = string;//base84 string

export * from './rpc';
import {IRPC, RPC} from './rpc';
import { PugdagAPI } from './apiHelpers';
