...
import {Wallet as WalletImpl, initPugdagFramework} from '@pugdag/wallet';
import {TxSend, TxInfo} from '@pugdag/wallet/types/custom-types';
...
export class WorkerCore extends EventEmitter{
	...
	async init(){
		...
		super.init();
		workerLog.debug("before initPugdagFramework")
		await initPugdagFramework();
		workerLog.debug("after initPugdagFramework")
