...
const { Wallet, EventTargetImpl, helper, pugdagcore, CONFIRMATION_COUNT, COINBASE_CFM_COUNT } = require('../../wallet');
const {HDPrivateKey} = pugdagcore;
...
export const initPugdagFramework = (opt:{workerPath?:string}={})=>{
	return new Promise<void>((resolve, reject)=>{
		helper.dpc(2000, ()=>{
			...
			workerLog.info("initPugdagFramework", url, baseURL)
